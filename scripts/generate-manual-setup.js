...
/**
 * Manual Setup Guide Generator for MANA Gaming Project
 * This creates detailed instructions for manual Appwrite setup
 */
...
const PROJECT_ID = process.env.APPWRITE_PROJECT_ID || '688e1e520023df233fb5';
...
1. Go to: https://cloud.appwrite.io/console/project-${PROJECT_ID}/databases
...
1. Go to: https://cloud.appwrite.io/console/project-${PROJECT_ID}/auth/settings
...
1. Go to: https://cloud.appwrite.io/console/project-${PROJECT_ID}/storage
...
`;
  ...
  // Write to file
  const outputPath = path.join(__dirname, '..', 'MANUAL_SETUP_GUIDE.md');
  fs.writeFileSync(outputPath, setupInstructions);
  
  console.log('✅ Manual setup guide created: MANUAL_SETUP_GUIDE.md');
  console.log(`
🎯 Quick Setup Links:

1. **Database**: https://cloud.appwrite.io/console/project-${PROJECT_ID}/databases
2. **Authentication**: https://cloud.appwrite.io/console/project-${PROJECT_ID}/auth/settings  
3. **Storage**: https://cloud.appwrite.io/console/project-${PROJECT_ID}/storage

📖 Follow the detailed guide in MANUAL_SETUP_GUIDE.md for step-by-step instructions.
  `);
}
